...
while j<=7*Pt2/10
    ...
    while i <= length(ll)
        ...
        Y1=B*log2(1+((namuda/(4*pi*d)))^2*Gt*Gr*j/(N+N_1));%bit/s
        t1=L/Y1;
...
set(gca,'YTick',[0:0.1:1.3],'FontSize',25) %y axis range 0-1, interval 0.1
axis square;
hold on;
% Add title and tags
%title('PoA');
...
save data_N_1 x y11 y12 y13 y14 y21 y22 y23 y24 dstep1 dstep2 choose D2
